...
::: callout-note
该文章来自 [r-statistics.co](https://r-statistics.co/Top50-Ggplot2-Visualizations-MasterList-R-Code.html) 翻译参考了[知乎-数据分析、特征工程的可视化](https://zhuanlan.zhihu.com/p/364735713)
:::

英文原版 For original version in English @sec-top50ggplot2en
